...
* **Gestor de Usuarios:** Ventana modal independiente para registrar nuevos clientes directamente en la base de datos.
...
### Módulo Financiero y Trazabilidad
* **Auditoría de Sesiones:** Registro histórico de cada sesión de PC finalizada con su respectiva hora de inicio, fin y monto exacto cobrado.
* **Historial de Tienda:** Trazabilidad absoluta de cada snack o bebida vendida, respaldada por una base de datos normalizada con integridad referencial (Llaves Foráneas hacia Usuarios y Productos).
* **Cuadre de Caja (Cierre de Turno):** Generación de un voucher digital en tiempo real que suma y desglosa los ingresos totales del día (Alquileres de PC + Ventas de Kiosco) logrando un balance contable exacto.
